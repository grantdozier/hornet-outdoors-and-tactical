  ...
  return (
    <section className="stack">
      ...
      <div className="grid-3">
        <PlaceholderImage label="Hat style 1" />
        <PlaceholderImage label="Hat style 2" />
        <PlaceholderImage label="Hat style 3" />
      </div>

      <p><a href="https://www.wholesalehats.com/Style-Number-112PC" target="_blank">https://www.wholesalehats.com/Style-Number-112PC</a></p>
    </section>
  )
}
